...
export const products: Product[] = [
  ...
  // Speakers and Audios
  { id: '21', name: 'JBL Charge 5', price: 179, image: 'https://images.unsplash.com/photo-1589254065878-42c9a3d25a05?w=400&h=300&fit=crop&crop=center&auto=format', category: 'speakers-and-audios', subcategory: 'Bluetooth Speakers', description: 'Portable Bluetooth speaker with deep bass.', brand: 'JBL', condition: 'new', rating: 4.5 },
  { id: '22', name: 'Sony WH-1000XM5', price: 399, image: 'https://images.unsplash.com/photo-1589254065878-42c9a3d25a05?w=400&h=300&fit=crop&crop=center&auto=format', category: 'speakers-and-audios', subcategory: 'Headphones', description: 'Premium noise-canceling wireless headphones.', brand: 'Sony', condition: 'new', rating: 4.7 },
  { id: '23', name: 'HomePod Mini', price: 99, image: 'https://images.unsplash.com/photo-1589254065878-42c9a3d25a05?w=400&h=300&fit=crop&crop=center&auto=format', category: 'speakers-and-audios', subcategory: 'Sound Systems', description: 'Smart speaker with Siri and spatial audio.', brand: 'Apple', condition: 'new', rating: 4.4 },
  { id: '24', name: 'Soundbar', price: 299, image: 'https://images.unsplash.com/photo-1589254065878-42c9a3d25a05?w=400&h=300&fit=crop&crop=center&auto=format', category: 'speakers-and-audios', subcategory: 'Sound Systems', description: 'Dolby Atmos soundbar for immersive audio.', brand: 'Samsung', condition: 'new', rating: 4.3 }
];
